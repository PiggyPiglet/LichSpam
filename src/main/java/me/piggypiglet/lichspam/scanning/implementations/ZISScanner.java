package me.piggypiglet.lichspam.scanning.implementations;

import me.piggypiglet.lichspam.boot.LichSpamBootstrap;
import me.piggypiglet.lichspam.scanning.exceptions.ScanningException;
...
import me.piggypiglet.lichspam.utils.annotation.wrapper.AnnotationUtils;
...
public final class ZISScanner implements Scanner {
    private static final Class<?> MAIN = LichSpamBootstrap.class;
    private static final String PACKAGE = "me/piggypiglet/lichspam";
